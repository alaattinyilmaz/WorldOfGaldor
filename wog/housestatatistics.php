	...
	<tr>
		...
		<div align="center">
	      ...
	      <p align="center">
            <ul>
            <ul>
              <li>Crowd is sometimes strength.<br>
              Here is the most crowded house(s) among all houses. </li>
            </ul>
	      </p>
...
?>
  ...
  <?php
    ...
    echo "<tr>
          ...
          <td><center><font color='#79BD8B'>$money</font></center></td>
          </tr>";
}
