...
<center>
  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<div align="center">
	      <p class="style3">BOSSES</p>
	      <p>Here are the bosses in this merciless world. <br>
            <br>
	      ...
	      <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="264" bgcolor="#333333" class="style8">Boss Name</th>
          <th width="129" bgcolor="#333333" class="style8">Item</th>
          <th width="129" bgcolor="#333333" class="style8">Rareness</th>
          <th width="129" bgcolor="#333333" class="style8">Located At</th>
      </tr>
            </thead>
            <tbody>
...
$sql = 'SELECT B.bName, L.lName, B.rareness, I.iName
        FROM boss B, land L, item I
        WHERE B.is_located_at = L.lID and B.drops = I.iID
		GROUP by B.bName';
...
$sqlCount = 'SELECT COUNT(*) as count FROM boss';
...
?>
  ...
  <?php
    ...
    echo "<tr>
          <td><center><font color='#e88c42'>$boss</font></center></td>
          <td><center><font color='#9fe6e5'>$item</font></center></td>
          <td><center><font color='#cf9fe6'>$rare</font></center></td>
          <td><center><font color='#79BD8B'>$location</font></center></td>
          </tr>";
}
...
?>
        ...
        </div>        <br> <p align="center">There are <?php echo $count ?> bosses in World of Galdor.</p>
