...
<center>
  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td rowspan="2">&nbsp;</td>
		<td width="301" bgcolor="#454A61" border="1"  bordercolor="38394F" ><table width="276" height="370" border="1" align="center" bordercolor="#003333">
          <tr>
          ...
          <tr>
            <td height="22"><a href="valuabletradingitems.php"><img src="images/icon.png" width="10" height="10" border="0"/> VALUABLE TRADING ITEMS </a></td>
          </tr>
        </table></td>
		...
		<div align="center">
	      <p class="style3">TRADEBOOK</p>
	      <p>Trade logs between people. <br>
            <br>
	      ...
	      <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="300" bgcolor="#333333" class="style8">Seller</th>
          <th width="300" bgcolor="#333333" class="style8">Purchaser</th>
          <th width="129" bgcolor="#333333" class="style8">Item</th>
          <th width="250" bgcolor="#333333" class="style8">Date</th>
          <th width="150" bgcolor="#333333" class="style8">Price</th>
      </tr>
            </thead>
            <tbody>
...
$sql = 'SELECT P1.pName as Seller, P2.pName AS Purchaser, T.date, T.price, I.iName
        FROM trades_with T, person P1, person P2, item I
        WHERE T.iID = I.iID and T.from = P1.pID and T.to = P2.pID';
		
		

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM trades_with';
...
?>
  ...
  <?php
    ...
    echo "<tr>
          <td><center><font color='#e88c42'>$from</font></center></td>
          <td><center><font color='#9fe6e5'>$to</font></center></td>
          <td><center><font color='#d17d92'>$item</font></center></td>
          <td><center><font color='#cf9fe6'>$date</font></center></td>
          <td><center><font color='#79BD8B'>$price</font></center></td>
          </tr>";
}
...
?>
        ...
        </div>        <br> <p align="center">There are <?php echo $count ?> trade records in World of Galdor.</p>
