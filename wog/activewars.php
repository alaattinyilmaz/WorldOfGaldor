  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<div align="center">
	      ...
	      <p>Active wars between houses <br>
            <br>
...
$sql = "SELECT H1.hName as HouseDeclare, H2.hName AS HouseDefense, W.since, W.until, W.reward
        ...
        WHERE W.declarer = H1.hID and W.defensor = H2.hID and W.until = 'still'
		GROUP by W.wID";
...
$sqlCount = "SELECT COUNT(*) as count FROM in_war_with WHERE until = 'still'";
...
?>
        ...
        </div> <p align="center"><?php echo $count ?> wars are currently happening in WOG.</p>
