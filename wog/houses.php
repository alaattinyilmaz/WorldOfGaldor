...
<center>
  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<div align="center">
	      <p align="center" class="style3">HOUSES</p>
	    ...
	    <div align="center">
          ...
          <th width="129" bgcolor="#333333" class="style8">Land</th>
      </tr>
            </thead>
            <tbody>
...
?>
  ...
  <?php
    ...
    echo "<tr>
          ...
          <td><center><font color='#79BD8B'>$land</font></center></td>
          </tr>";
}
...
?>
        ...
        </div>        <br> <p align="center">There are <?php echo $count ?> houses.</p>
