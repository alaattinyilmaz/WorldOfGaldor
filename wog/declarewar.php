...
<center>
  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<div align="center">
	      <p class="style3">DECLARE A WAR </p>
	      <p class="style3">
	        <?php
...
$sql_house = "SELECT H.hName, H.hID
				FROM house H";
				
$houseresult = mysqli_query($db, $sql_house);
$houseresult2 = mysqli_query($db, $sql_house);


?>
 </p>
	      <form action="declarewar.php" method="post">
          <table width="307" height="118" border="1" bordercolor="#003333">

            <tr>
              <td width="150" height="26"><div align="center">Declarer</div></td>
              <td width="141">
                <div align="center">
        ...
        ?>
            ...
            <tr>
              <td height="26"><div align="center">Defensor:</div></td>
              <td><div align="center">
                <select name="defensor">
		<?php
		
        while($row = mysqli_fetch_assoc($houseresult2)) {
			$housename = $row['hName'];
			$houseid = $row['hID'];
        ...
        ?>
            ...
            <tr>
              <td height="26"><div align="center">Demanding Money:</div></td>
              <td>
                <div align="center">
                  <input type="text" name="reward" size="5">
                </div></td>
            </tr>
            <tr bordercolor="#454A61">
              <td height="28">&nbsp;</td>
              <td><input name="submit" type="submit" value="DECLARE"></td>
            </tr>
          </table>
...
if($defensor == $declarer)
{
echo "<font color = 'dd7171'>You can not start a war with yourself. It would be funny.</font>";
}


else {

$war_query = "INSERT INTO in_war_with (declarer, defensor, reward, since, until)
VALUES ('$declarer', '$defensor', '$reward', '$since', '$until');";

$warresult = mysqli_query($db, $war_query);

			if($warresult) 
			{
			echo "<font color = '#4bbe19'>A new war is created. May the force with you.</font>";
			}
			
			else 
			{
			echo "<font color = '#dd7171'>You could not start a war.</font>";
			}
