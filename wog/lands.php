...
<center>
  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<div align="center">
	      <p class="style3">LANDS</p>
          </p>
	      <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="264" bgcolor="#333333" class="style8">Land Name</th>
          <th width="129" bgcolor="#333333" class="style8">Notable Resource</th>
      </tr>
            </thead>
            <tbody>
...
$sql = 'SELECT L.notableResources, L.lName
        FROM Land L
		';
...
?>
  ...
  <?php
    ...
    echo "<tr>
          <td><center><font color='#e88c42'>$landname</font></center></td>
          <td><center><font color='#9fe6e5'>$resource</font></center></td>
          </tr>";
}
...
?>
        ...
        </div>        <br> <p align="center">There are <?php echo $count ?> lands in World of Galdor.</p>
