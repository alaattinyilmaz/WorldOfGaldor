...
<center>
  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<div align="center">
	      <p align="center" class="style3">HOUSE TREASURIES  </p>
	      <p align="center">Amount of money that houses earned from trading activities </p>
	    ...
	    <div align="center">
          ...
          <th width="129" bgcolor="#333333" class="style8">Money</th>
      </tr>
            </thead>
            <tbody>
...
$sql = 'SELECT h.hName, SUM(T.price) as TOTALMONEY
FROM trades_with T, person P, house H
WHERE T.from = P.pID and H.hID = P.is_member_of
