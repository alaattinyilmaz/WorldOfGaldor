  ...
  <table width="1123" height="357" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		...
		<td width="301" bgcolor="#454A61" border="1"  bordercolor="38394F" ><table width="276" height="389" border="1" align="center" bordercolor="#003333">
          ...
          <tr>
            <td><a href="housestatistics.php"><img src="images/icon.png" width="10" height="10" border="0"/> MOST CROWDED HOUSE </a></td>
          </tr>
          <tr>
		...
		<div align="center">
	      <p align="center" class="style3">MOST CROWDED HOUSE </p>
	      <p align="center">Crowd is sometimes strength.<br>
          Here is the most crowded house(s) among all houses. </p>
	    ...
	    <div align="center">
          <table width="541" style = "border: 1px dashed">
            <thead>
              <tr>
          <th width="264" bgcolor="#333333" class="style8">House Name</th>
          <th width="129" bgcolor="#333333" class="style8">Population</th>
      </tr>
            </thead>
            <tbody>
...
$sql = 'SELECT T.hID, T.hName, COUNT(*) AS population
FROM (SELECT P.pID, H.hID, H.hName
	  FROM house H, person P
	  WHERE P.is_member_of = H.hID) AS T
GROUP BY T.hID
HAVING COUNT(*) >= ALL (SELECT COUNT(*)
                       	FROM person P
                       	GROUP BY P.is_member_of)';
		
		

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM house';
...
?>
  ...
  <?php
    ...
    echo "<tr>
          ...
          <td><center><font color='#79BD8B'>$population</font></center></td>
          </tr>";
}
